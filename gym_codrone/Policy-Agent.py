...
gamma = 0.9
epsilon = 0.9
epsilon_discount = 0.1 # 8 eps to reach 0.1
#nepisodes = 8
#nsteps = 10
...
#Y = 0.0
#Z = 2000
#max_altitude = 2000   # in mm
#max_incl = 25       # -100 to 100
#speed_value: 1.0    # in m/s
#running_step: 0.3   # in seconds
